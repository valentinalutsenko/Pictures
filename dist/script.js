...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusImg.appendChild(textMessage);
...
var scroll = function scroll(upSelector) {
  ...
  var calcScroll = function calcScroll() {
    upElem.addEventListener('click', function (event) {
      ...
      if (this.hach !== '') {
        event.preventDefault();
        var hachElem = document.querySelector(this.hach),
            hachElemTop = 0;
  ...
  var smoothScroll = function smoothScroll(from, to, hach) {
    var timeInterval = 1,
        prevScrollTop,
        speed;
